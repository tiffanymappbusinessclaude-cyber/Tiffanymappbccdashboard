-- =========================================================================
-- Migration: seed_bcc_automations_function
-- Supabase version: 20260613150220
...
BEGIN
    ...
    IF v_existing_count > 0 THEN
        RETURN jsonb_build_object(
            ...
            'message', format('Agency %s already has %s recipes — no action taken.', p_agency_id, v_existing_count),
...
'Seeds the canonical 14-recipe BCC automation suite for a new client agency. Idempotent.';
